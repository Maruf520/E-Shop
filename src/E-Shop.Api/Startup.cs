...
using E_Shop.Services.Services;
...
namespace E_Shop.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "E_Shop.Api", Version = "v1" });
            });
           services.AddDbContext<E_StoreDbContext>(options =>
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "E_Shop.Api v1"));
            }
